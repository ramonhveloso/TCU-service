...
from app.api.v1.extra_expenses.extra_expense_controller import router as extra_expenses_router
...
router.include_router(extra_expenses_router, prefix="/extra-expenses", tags=["ExtraExpenses"])
