...
async def test_get_journeys(use_test_client):
    ...
    post_expenses_response = use_test_client.post("/api/v1/journeys/", headers=headers, params=json_request)
...
async def test_get_by_id_journeys(use_test_client):
    ...
    get_expenses_response = use_test_client.get(f"/api/v1/journeys/{journey_id}", headers=headers)
    assert get_expenses_response.status_code == 200
...
async def test_put_by_id_journeys(use_test_client):
    ...
    journey_id = post_expenses_response.json()["response"]["id"]
    put_expenses_response = use_test_client.put(f"/api/v1/journeys/{journey_id}", headers=headers, json=json_request)
...
async def test_delete_by_id_journeys(use_test_client):
    ...
    journey_id = post_expenses_response.json()["response"]["id"]
    delete_expenses_response = use_test_client.delete(f"/api/v1/journeys/{journey_id}", headers=headers)
...
async def test_post_multiple_journeys(use_test_client):
    ...
    post_expenses_response = use_test_client.post("/api/v1/journeys/multiple", headers=headers, json=json_request)
    assert post_expenses_response.status_code == 201